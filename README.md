...
```sh
./codexion number_of_coders time_to_burnout time_to_compile time_to_debug \
           time_to_refactor number_of_compiles_required dongle_cooldown scheduler | ./codexion_live
```
Then reach [codexion_visualizer](https://codexion-visualizer.sacha-dev.me/) and run live.
